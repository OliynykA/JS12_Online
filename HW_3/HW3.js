...
//7
{
    let str = "какой-то текст в котором есть один тэг <hr> и всякое другое";//строка по умолчанию;
    let index1 = str.indexOf('<hr>');//вычисление индекса тега;
    let index2 = '<hr>'.length;//вычисление длинны тега;
